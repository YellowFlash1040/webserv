...
class RequestHandler
{
	...
	void processRequest(RawRequest& rawReq, const NetworkEndpoint& endpoint, RequestContext& ctx);
	...
	void processGet(RequestData& req, const NetworkEndpoint& endpoint, RequestContext& ctx, RawResponse& resp);
	...
	std::string handleCGI(RequestData& req, const NetworkEndpoint& endpoint, const std::string& interpreter, const std::string& scriptPath);

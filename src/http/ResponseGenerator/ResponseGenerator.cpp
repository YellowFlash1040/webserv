...
// void RequestHandler::processRequest(const RawRequest& rawReq, const NetworkEndpoint& endpoint,
...
// void RequestHandler::processDelete(RequestData& req, const NetworkEndpoint& endpoint, const RequestContext& ctx, RawResponse& rawResp)
// {
// 	(void)req;
// 	(void)endpoint;
